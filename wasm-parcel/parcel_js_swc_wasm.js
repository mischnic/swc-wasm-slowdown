...
* @returns {any}
*/
module.exports.execute = function execute(query, opts) {
...
* @returns {any}
*/
module.exports.transform = function transform(config_val) {
    var ret = wasm.transform(addHeapObject(config_val));
    return takeObject(ret);
}
...
async function init(input) {
    ...
    //     input = new URL('parcel_js_swc_wasm_bg.wasm', import.meta.url);
    // }
    // if (typeof input === 'string' || (typeof Request === 'function' && input instanceof Request) || (typeof URL === 'function' && input instanceof URL)) {
    //     input = fetch(input);
    // }
    input = require("fs").readFileSync(__dirname + "/parcel_js_swc_wasm_bg.wasm");
